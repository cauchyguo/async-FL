...
class FLECNormalGroupManager(BaseGroupManager):
    def __init__(self, config):
        ...
        self.group_list,self.edge_server_num = self.group_caller.group(self.client_list,self.latency_list)
    ...
    def __group(self, *args, **kwargs):
        self.group_list,self.edge_server_num = self.group_caller.group( *args, **kwargs)
        return self.edge_unique_groups,self.edge_server_num
